...
export const SideBar = () => {
  ...
  return (
    <section className="side-bar overflow-y-auto h-[100%] bg-[#151515] size-full m-1 rounded-lg text-white shadow-md border-[.4px] border-black sticky top-0 py-4 pb-20 transition-all left-0 px-4">
